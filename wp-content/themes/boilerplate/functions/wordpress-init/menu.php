...
register_nav_menus(
    ...
    'quick-links'	=> __( 'Quick Links', 'jointswp' ),			// Secondary nav in footer
    'minster-online'	=> __( 'Minster Online', 'jointswp' )			// Secondary nav in footer
	)
);
...
function quick_links() {
	wp_nav_menu(array(
		'container'			=> 'false',				// Remove nav container
		'menu_id'			=> 'quick-links',		// Adding custom nav id
...
function minster_online() {
	wp_nav_menu(array(
		'container'			=> 'false',				// Remove nav container
		'menu_id'			=> 'minster-online',		// Adding custom nav id
		'theme_location'	=> 'minster-online',		// Where it's located in the theme
		'depth'				=> 0,					// Limit the depth of the nav
		'fallback_cb'		=> ''					// Fallback function
	));
} /* End Footer Menu */
